...
const ColorType MILD_GREEN_COLOR = B00001000;

RGBLEDMatrix leds(10,10);

PROGMEM ColorType const invader1A[64] = {
    TRANSPARENT_COLOR,TRANSPARENT_COLOR,TRANSPARENT_COLOR,MILD_GREEN_COLOR,MILD_GREEN_COLOR,TRANSPARENT_COLOR,TRANSPARENT_COLOR,TRANSPARENT_COLOR, 
    TRANSPARENT_COLOR,TRANSPARENT_COLOR,MILD_GREEN_COLOR,MILD_GREEN_COLOR,MILD_GREEN_COLOR,MILD_GREEN_COLOR,TRANSPARENT_COLOR,TRANSPARENT_COLOR,
    TRANSPARENT_COLOR,MILD_GREEN_COLOR,MILD_GREEN_COLOR,MILD_GREEN_COLOR,MILD_GREEN_COLOR,MILD_GREEN_COLOR,MILD_GREEN_COLOR,TRANSPARENT_COLOR,
    MILD_GREEN_COLOR,MILD_GREEN_COLOR,WHITE_COLOR,MILD_GREEN_COLOR,MILD_GREEN_COLOR,WHITE_COLOR,MILD_GREEN_COLOR,MILD_GREEN_COLOR,
    MILD_GREEN_COLOR,MILD_GREEN_COLOR,MILD_GREEN_COLOR,MILD_GREEN_COLOR,MILD_GREEN_COLOR,MILD_GREEN_COLOR,MILD_GREEN_COLOR,MILD_GREEN_COLOR,
    TRANSPARENT_COLOR,TRANSPARENT_COLOR,MILD_GREEN_COLOR,TRANSPARENT_COLOR,TRANSPARENT_COLOR,MILD_GREEN_COLOR,TRANSPARENT_COLOR,TRANSPARENT_COLOR,
    TRANSPARENT_COLOR,MILD_GREEN_COLOR,TRANSPARENT_COLOR,MILD_GREEN_COLOR,MILD_GREEN_COLOR,TRANSPARENT_COLOR,MILD_GREEN_COLOR,TRANSPARENT_COLOR,
    MILD_GREEN_COLOR,TRANSPARENT_COLOR,MILD_GREEN_COLOR,TRANSPARENT_COLOR,TRANSPARENT_COLOR,MILD_GREEN_COLOR,TRANSPARENT_COLOR,MILD_GREEN_COLOR
};
...
PROGMEM ColorType const invader1B[64] = {
    ...
    TRANSPARENT_COLOR,TRANSPARENT_COLOR,MILD_GREEN_COLOR,TRANSPARENT_COLOR,TRANSPARENT_COLOR,MILD_GREEN_COLOR,TRANSPARENT_COLOR,TRANSPARENT_COLOR,
    TRANSPARENT_COLOR,MILD_GREEN_COLOR,TRANSPARENT_COLOR,MILD_GREEN_COLOR,MILD_GREEN_COLOR,TRANSPARENT_COLOR,MILD_GREEN_COLOR,TRANSPARENT_COLOR,
    TRANSPARENT_COLOR,MILD_GREEN_COLOR,TRANSPARENT_COLOR,TRANSPARENT_COLOR,TRANSPARENT_COLOR,TRANSPARENT_COLOR,MILD_GREEN_COLOR,TRANSPARENT_COLOR
};
...
// fourth
ImageSequenceAnimation::Frame ani4[5] = {
  {
    &a4a,
    1, 1,
    250
...
RGBAnimationSequence::AnimationItem aniItems[ANIMATION_ITEMS_SIZE] {
  ...
  {
    new ImageSequenceAnimation( leds, ani4, 5 ),
    6000,
    2000,
